...
var ListProvidermMonthAvailabilityService = /** @class */ (function () {
    function ListProvidermMonthAvailabilityService(appointmentsRepository) {
        this.appointmentsRepository = appointmentsRepository;
    }
    ListProvidermMonthAvailabilityService.prototype.execute = function (_a) {
    ...
    ListProvidermMonthAvailabilityService = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject('AppointmentsRepository')),
        __metadata("design:paramtypes", [Object])
    ], ListProvidermMonthAvailabilityService);
    return ListProvidermMonthAvailabilityService;
}());
exports.default = ListProvidermMonthAvailabilityService;
