...
describe('CreateAppointment', function () {
    ...
    it('should not be able to create two appointment in the same time', function () { return __awaiter(void 0, void 0, void 0, function () {
        var appointmentDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appointmentDate = new Date(2020, 4, 6, 11);
