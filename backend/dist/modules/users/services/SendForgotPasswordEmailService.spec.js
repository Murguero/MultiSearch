...
describe('SendForgotPasswordEmailService', function () {
    beforeEach(function () {
        ...
        sendForgotEmailService = new SendForgotPasswordEmailService_1.default(fakeUserRepository, fakeMailProvider, fakeUserTokensRepository);
    });
    it('should be able to recover the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotEmailService.execute({
                            email: 'johndoe@example.com',
                        })];
                case 2:
                    _a.sent();
    ...
    it('should not be able to recover a non-existing user password ', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotEmailService.execute({
                        email: 'johndoe@example.com',
